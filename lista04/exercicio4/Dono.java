...
identificado pelo seu nome, idade e sexo. 
Além disso, sabe-se que cada animal possui um dono o qual é identificado pelo cpf, nome, telefone e email, além de possuir um endereço que
...
public class Dono {
	...
	public Dono(String nome, String telefone, String email, String cpf, Endereco endereco) {
		super();
		this.nome = nome;
	...
	public String toString() {
		return "Dono [nome=" + nome + ", telefone=" + telefone + ", email=" + email + ", cpf=" + cpf + "\n"
				+ endereco + "]";
	}
